...
/***captured the piece****/
     for(int init_pos=120;init_pos>20;init_pos-=2)
     {   
         myservo3.write(init_pos);
         delay (20);
     }
     ...
     /*rotated to the position to release the piece*/
     for(int init_pos=20;init_pos<120;init_pos+=2)
     {   
         myservo3.write(init_pos);
         delay (20);
     }
    ...
    /*became in a better position not to get broken by the base*/
     for(int init_pos=90;init_pos>0;init_pos-=2)
     {
         myservo.write(init_pos);
         delay (20);
     }
     /*rotated to the inital position*/
